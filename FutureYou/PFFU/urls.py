...
urlpatterns = [
    ...
    url(r'^understanding_yourself_yes', PFFU.views.understanding_yourself_yes, name='understanding_yourself_yes'),
    url(r'^understanding_yourself_no', PFFU.views.understanding_yourself_no, name='understanding_yourself_no'),
