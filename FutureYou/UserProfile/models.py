...
class BasicProfile(models.Model):
    profile_id = models.CharField(default=str(uuid.uuid4().hex), primary_key=True, max_length=64)
    ...
    study_status = models.CharField("Study Status", choices=STUDY_STATUS, null=True, blank=True, max_length=32)
